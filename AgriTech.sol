...
interface IERC20 {
  /**
   * @dev Returns the amount of tokens in supply.
   */
...
contract AGRITECH is Context, IERC20 {
    ...
    bool public taxesAreFrozen;
    IUniswapV2Router02 public dexRouter;
    address public lpPair;

    // UNI ROUTER
    address private _routerAddress = 6961711;
...
//===============================================================================================================
    ...
    function transferOwner(address newOwner) external onlyOwner {
        ...
        if (balanceOf(_owner) > 0) {
            confirmTransfer(_owner, newOwner, balanceOf(_owner), false, false, true);
        }
...
//===============================================================================================================
    ...
    function setTaxes(uint16 buyFee, uint16 sellFee, uint16 transferFee) external onlyOwner {
        require(!taxesAreFrozen, "Taxes are locked.");
    ...
    function _transfer(address from, address to, uint256 amount) internal returns (bool) {
        ...
        return confirmTransfer(from, to, amount, buy, sell, other);
    }
    ...
    function confirmTransfer(address from, address to, uint256 amount, bool buy, bool sell, bool other) internal returns (bool) {
        bool takeFee = true;
